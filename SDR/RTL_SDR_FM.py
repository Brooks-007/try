...
class RTL_SDR_FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "RTL FM Receiver", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RTL FM Receiver")
        ...
        self._tune_range = Range(87000000, 108000000, 0.1e6, 100000000, 200)
        ...
        self.iio_pluto_source_0.set_frequency(tune)
        ...
        self.connect((self.analog_fm_demod_cf_0_0, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_tune(self, tune):
        self.tune = tune
        self.iio_pluto_source_0.set_frequency(self.tune)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate/5/10)
